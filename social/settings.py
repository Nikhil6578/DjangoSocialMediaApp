"""
Django's settings for social project.
...
SECRET_KEY = ('django-insecure-v4i*&(an$$n5q_(('
              '51-^t*p5t^))wn2*06^+hyaofd19ptpuda')
...
DATABASES = {
    'default': {
        ...
        'PORT': '',  # Leave it empty for the default PostgresSQL port (5432)
    }
}
